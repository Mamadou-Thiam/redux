    ...
    <div className="">
      <li className="w-[auto]  border-b border-gray-200 rounded-t-lg dark:border-gray-600">
        <div className="flex justify-around ">
          ...
          <button
            onClick={handleDeleteClick} //pour supprimer une tache
            className="sup"
          >
            Delete
          </button>
          <button
            ...
            className="edit"
          >
            Edit //button pour afficher un champ apres un click sur edit pour
            modifier une tache
          </button>
          {isEdit && (
            <>
              ...
              />
              <button onClick={Update} className="updat">
                Update
              </button>
            </>
          )}
